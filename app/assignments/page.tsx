                ...
                <div className="p-10">
                    <div className="border-gray-700 bg-black p-4">
                        ...
                        <ul className="list-disc pl-6 text-gray-300 space-y-4 mb-6">
                            ...
                            <li>
                                <strong>Assignment 10:</strong> Image Retrieval
							<div>
								<a href="https://github.com/isaadev/isaa-assignment-10" className="block text-sm bg-gray-400 rounded-lg p-2 mt-2 w-fit">Github Link</a>
                                <a href="https://youtu.be/c9IcLPJnOrc" className="block text-sm bg-gray-400 rounded-lg p-2 mt-2 w-fit">Demo Link</a>
